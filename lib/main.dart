...
Future<List<dynamic>> getProfilePIctures() async {
  ...
  var url = Uri.parse("https://randomuser.me/api/?results=8"); // utilisation de l'api random user pour génerer les information  des utilisateur 
  // Appel
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                                Text(" nom : ${bagareuer['name']['first']}  ${bagareuer['name']['last']}   "), // crée des valeur fictive 
                                Text(
